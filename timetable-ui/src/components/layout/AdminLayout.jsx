...
import { Calendar, Users, BookOpen, GraduationCap, Building, LogOut, LayoutDashboard, ChevronRight, DoorOpen, BookMarked, UsersRound } from 'lucide-react';
...
const BASE_MENU = [
    ...
    { to: '/faculty', label: 'Faculties', icon: Users },
    { to: '/rooms', label: 'Rooms', icon: DoorOpen },
    { to: '/timetable', label: 'Timetable', icon: GraduationCap },
];
